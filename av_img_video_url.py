...
ALL_ITEMS = {
    ...
    '36': ['doks','drop','dkwt','dmow'],  '41':['hodv','om','pjf','ly','pmc'],'42': ['sp'],'49':['mgdv'],     '55': ['davk','tmavntgvr','T28'], 
    ...
    'h_259':['vnds'],'h_244': ['saba','supa'], 'h_1575': ['sgkx'], 'h_1256': ['tpvr','tprm'], 'h_1127': ['vovs','gopj','vosf','vosm'],
