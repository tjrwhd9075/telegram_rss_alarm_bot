...
ALL_ITEMS = {
    '1': ['rct','sdmt','nag','gs','atom','sdmua','msfh','svvrt','mist','silkbt','shh','acme','nhdta','sdmf','mogi','stcv',"hunta",'drpt','mgold','votan','noskn','paioh','bkynb','mtall','hunt','sdfk','silku','star','stars','sdjs','sdnm','kmhr','sdth','kuse','sdab','sdmm','danuhd','nyh','zozo','ftht','akdl','silks','sdam','sdde','kire','shn','fsdss','fsvss','nhdtb','svdvd','iesp','piyo','dldss','sun','dandy','rctd','hawa','sw','ienf','gs','hbad','okb','dandan','nhvr','havd','mtvr','iesm','ftdss','okp','oks','svomn','hypn','sdnt','sdmu','nttr','fset','shyn','dvdm','miha'],
    '2': ['ecb','wzen','wpom','ekbe','dfe','wfr','ekw','wpvr','wkd'],  '12': ['bur','lol','imo','scr'], '13': ['gbd','gvg','dsvr','gqe','ovg','yvg','rvg'],
    '17':['mkd'],'18': ['jkzk','mght','sprd','ntrd','spbx','mond'],  '21':['psd'],'24': ['cmd','dyd','dtsl','dfbvr','vdd','ped'],  '30': ['nha','msc','msa'],'33':['dph'],
    '36': ['doks','drop','dkwt','dmow'],  '41':['hodv','om','pjf','ly','pmc'],'42': ['sp'],'48':['mdvhj'],'49':['mgdv'],     '55': ['davk','tmavntgvr','T28'], 
    '57': ['jksr','mcsr','itsr','bdsr','husr','sgsr'],'60':['xv'],'61':['mds'], '71': ['gas'],    '84': ['mdtm','mkmp','kmvr','umso'], 
    '86': ['axdvd'], '100': ['tv','yen'],'118':['kkj','aka','giro','yzf'],     '125': ['umd'], '143': ['mom','shm'],     '149': ['rd'],    '171': ['lhtd'], '172': ['xrw'], '189': ['hsf'], '301': ['mbdd'],
    ...
    'h_918':['tad'],'h_574': ['iqpa'], 'h_1569': ['nkkvr'], 'h_086': ['hthd','xmom','fera','keed','jrze','jura','mesu','nuka','abba','cvdx','toen','zeaa','iqqq','hima','ferax','iga','kaad','hone'],
    ...
    'h_967':['asw'],'h_1594': ['spro'], 'h_1096': ['bdsm'], 'h_113': ['bbacos','cb','ek','kpp','spo','sw','syk','sy','izm'],
...
DBMSIN_NUM_AMA_IMG =[
    '420HHL','026JKZK','099KKJ','360TAD','014DIY','278GZAP','223ECB','168RS','052VNDS','107SDMT','052PES','052OFKU','052NXGS','052NXG','052KIR','118RCT','110FSET','107STARS','298GOGO','223WPSL','001HMGL','169MDS','420STH','224DYD','263EMOT','224CMD','336DTT','225YSN','223WZEN','298PAIS','077GBD','324SRTD','271GS','390JNT','326KFNE','446KHOM','554SPIVR','107MSFH','563PPZ','390JAC','112SVVRT','224DTSL','201FONE','298PAKO','201CIEL','201DORI','002HODV','336KNB','595CHNYM','118RCTD','278GNAB','435MFC','300MAAN','480FRIN','277DCV','300NTK','259LUXU','230ORECO','726ANKK','702NOSKN','558KRS','520SSK','223EKBE','043PYM','278GIRO','005AOZ','352KNMD','107SDMUA','026MOND','109IENE','116SHH','307SHIC','1073DSVR','258DTSG','116ACME','336KBI','116NHDTA','107MOGI','336ASI','534IND','107SDMF','336ASI','003T28','201TDMN'
    ]
...
DBMSIN_AMA_IMG ={
    'FANZA' : ['hhl','pchn','tkwa','hoi','spay','60xv','sth','frin',"scute","pow","sqb","hmdnc","oreco","ankk",'ssk','mgmr'], #https://db.msin.jp/jp.images/cover/FANZA/scute1306.jpg
