...
ALL_ITEMS = {
    ...
    '422': ['kagd'], '433': ['gun','neo'], '436': ['bubb','yas'], '5013': ['tsds'], '504': ['ibw'],'540':['yst','wpe','bcm'],
    ...
    'h_1165': ['goju'], 'h_1553': ['ftvr'], 'h_1560': ['shind'],'h_452':["tmcy"],
...
DBMSIN_NUM_AMA_IMG =['595CHNYM','118RCTD','278GNAB','435MFC','300MAAN','480FRIN','277DCV','300NTK','259LUXU','230ORECO','726ANKK','702NOSKN','558KRS','520SSK','223EKBE','043PYM','278GIRO','005AOZ','352KNMD','107SDMUA','026MOND','109IENE','116SHH','307SHIC','1073DSVR','258DTSG','116ACME','336KBI','116NHDTA','107MOGI','336ASI','534IND','107SDMF','336ASI','003T28','201TDMN']
